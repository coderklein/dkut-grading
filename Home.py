...
st.warning("Try it! Select estimate score/set target, enter E020-01-9999/2020, pick Calculus 1 and play with sliding bars to get a total score. Currently serving TIE students...")
...
st.error("Instagram: @coder_klein: https://www.instagram.com/coder_klein/ ")
